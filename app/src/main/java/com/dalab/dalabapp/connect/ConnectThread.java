package com.dalab.dalabapp.connect;
...
public class ConnectThread extends Thread {
    ...
    public ConnectThread(BluetoothDevice device, BluetoothAdapter adapter, Handler handler) {
        ...
        try {
            ...
            tmp = device.createRfcommSocketToServiceRecord(MY_UUID);//从远程设备创建socket连接
        } catch (IOException e) { }
        mmSocket = tmp;
    }
    ...
    private void manageConnectedSocket(BluetoothSocket mmSocket) {//数据处理和服务器一样
